...
app.use(
  cors({
    origin: ["https://reddybok-front.vercel.app", "https://reddybok-admin.vercel.app"], // Replace '*' with the specific origin(s) you want to allow, e.g., 'https://yourdomain.com'
...
// MongoDB connection
mongoose.connect(`mongodb://infusionreddybook2:PEpfmF4ZctYcrRV7@cluster0-shard-00-00.l7gyj.mongodb.net:27017,cluster0-shard-00-01.l7gyj.mongodb.net:27017,cluster0-shard-00-02.l7gyj.mongodb.net:27017/DYNEXBET?replicaSet=atlas-yvhri3-shard-0&ssl=true&authSource=admin&retryWrites=true&w=majority&appName=Cluster0`)
